...
contract CompaniesSalaries {
    ...
    function getSalariesByCompanyId(uint256 _company_id) public view returns (CompaniesSalariesStructs.Salary[] memory) {
        CompaniesSalariesStructs.Salary[] memory salaries_by_company_id = new CompaniesSalariesStructs.Salary[](salaries.length);
        uint256 counter = 0;
    ...
    function getSalariesByCompanyName(string memory _company_name) public view returns (CompaniesSalariesStructs.Salary[] memory) {
        CompaniesSalariesStructs.Salary[] memory salaries_by_company_name = new CompaniesSalariesStructs.Salary[](salaries.length);
        uint256 counter = 0;
